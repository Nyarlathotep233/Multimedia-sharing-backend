...
// 解析post请求
app.use(bodyParser.json()) //因为请求'content-type': 'application/json'
...
app.get("/search", (req, res) => {
  ...
  async.parallel([
      function (callback) {
        ...
        mysearchSpider(req.query.searchContent).then((data) => {
      ...
      function (callback) {
        (async () => {
          ...
          var data = await bilisearchSpider(req.query.searchContent)
          movieArr.bilibili = data
          callback(null, data)
        })()
