...
module.exports = () => {
    (async () => {
        ...
        var homePageArr = await page.evaluate(() => {
            ...
            // songList 只有'推荐'
            // type recommend
            var elements = document.querySelectorAll('#songlist .swiper-slide>.swiper-slide-item');
            elements.forEach((element, i) => {
                var temp = {
                    ...
                    musicListPlayCount: element.querySelectorAll('.item-info>.item-playCnt')[0].innerText
                }
                // console.log("-------------")
            ...
            // song 只有'华语'
            // type China
            elements = document.querySelectorAll('#song .swiper-slide>.swiper-slide-item');
            ...
            // album
            elements = document.querySelectorAll('#album .swiper-slide>.swiper-slide-item');
            // console.log(elements)
            elements.forEach((element, i) => {
                var temp = {
                    ...
                    albumDate: element.querySelectorAll('.item-info>.singer>.update-time')[0] ? element.querySelectorAll('.item-info>.singer>.update-time')[0].innerText : ''
                }
                // console.log("-------------")
                // console.log(element)
            ...
            // billboard1
            elements = document.querySelectorAll('#billboard .thumb-1 .thumb-item>.thumb');
            // console.log(elements)
            elements.forEach((element, i) => {
                var temp = {
